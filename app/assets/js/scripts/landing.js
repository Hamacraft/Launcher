    ...
    sysAEx.on('message', (m) => {
        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    'Aucune installation de<br>Java compatible détectée',
                    'Pour rejoindre Hamacraft, vous avez besoin de Java 8 en version 64 bits. Voulez vous que le launcher l\'installe pour vous ? En installant Java, vous acceptez la <a href="http://www.oracle.com/technetwork/java/javase/terms/license/index.html">license d\'Oracle</a>.',
                    'Installer Java',
                ...
                setDismissHandler(() => {
                    $('#overlayContent').fadeOut(250, () => {
                        ...
                        setOverlayContent(
                            'Java est nécessaire<br>pour démarrer',
                            'Une installation de Java 8 en version 64 bits est nécessaire pour jouer.<br><br>Vous devez l\'installer manuellement pour continuer.',
                            'J\'ai compris',
                            'Retour'
                        )
                        setOverlayHandler(() => {
            ...
            if(m.result === true){
                ...
                setOverlayContent(
                    'Erreur :<br>Téléchargement de Java échoué',
                    'Malheuresement nous avons rencontré un problème lors de l\'installation de Java. Vous devez installer manuellement Java.',
                    'J\'ai compris'
                )
                setOverlayHandler(() => {
                    toggleOverlay(false)
...
function dlAsync(login = true){
    ...
    aEx.on('error', (err) => {
        ...
        showLaunchFailure('Erreur lors du lancement', err.message || 'Vérifiez la console (CTRL + Shift + i) pour plus de détails.')
    })
            ...
            if(login && allGood) {
                ...
                const gameStateChange = function(data){
                    ...
                    if(SERVER_JOINED_REGEX.test(data)){
                        DiscordWrapper.updateDetails('Connecté au serveur')
                    } else if(GAME_JOINED_REGEX.test(data)){
                        DiscordWrapper.updateDetails('Joue en solo')
                    }
                }
                ...
                const gameErrorListener = function(data){
                    ...
                    if(data.indexOf('Could not find or load main class net.minecraft.launchwrapper.Launch') > -1){
                        ...
                        showLaunchFailure('Erreur lors du lancement', 'Le fichier principal, LaunchWrapper, ne s\'est pas installé correctement. De ce fait, le jeu ne se lancera pas.<br><br>Pour palier à ce problème, désactivez temporairement votre antivirus et relancez le launcher.<br><br>Si vous avez du temps, veuillez nous <a href="https://github.com/Hamacraft/Launcher/issues">signaler le problème</a> et dites nous quel antivirus vous utilisez. Nous les contacterons ensuite pour régler ce problème.')
                    }
                }
    ...
    refreshDistributionIndex(true, (data) => {
        ...
        refreshDistributionIndex(false, (data) => {
            ...
            if(DistroManager.getDistribution() == null){
                showLaunchFailure('Erreur Fatale', 'Impossible de charger une copie de l\'index de distribution. Vérifiez la console (CTRL + Shift + i) pour plus de détails.')
