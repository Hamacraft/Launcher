        ...
        val.onclick = (e) => {
            ...
            for(let i=0; i<selectBtns.length; i++){
                if(selectBtns[i].hasAttribute('selected')){
                    ...
                    selectBtns[i].innerHTML = 'Sélectionner'
                }
            }
            val.setAttribute('selected', '')
            val.innerHTML = 'Sélectionné &#10004;'
        ...
        val.onclick = (e) => {
            ...
            if(Object.keys(ConfigManager.getAuthAccounts()).length === 1){
                ...
                setOverlayContent(
                    ...
                    'Pour utiliser le launcher vous devez être connecté à Minecraft. Vous devrez donc vous reconnecter.<br><br>êtes vous sûr de vouloir vous deconnecter ?',
                    'Déconnexion',
                    'Annuler'
                )
                setOverlayHandler(() => {
        ...
        authAccountStr += `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            ...
            <div class="settingsAuthAccountRight">
                ...
                <div class="settingsAuthAccountActions">
                    <button class="settingsAuthAccountSelect" ${selectedUUID === acc.uuid ? 'selected>Sélectionné &#10004;' : '>Sélectionner'}</button>
        ...
        <div class="serverListingDetails">
            ...
            <div class="serverListingInfo">
                ...
                ${serv.isMainServer() ? `<div class="serverListingStarWrapper">
                    ...
                    <span class="serverListingStarTooltip">Principal</span>
                </div>` : ''}
            </div>
        </div>
    `
...
function populateVersionInformation(version, valueElement, titleElement, checkElement){
    ...
    if(isPrerelease(version)){
        ...
        titleElement.innerHTML = 'Canal Stable'
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/Hamacraft/Launcher/releases.atom',
        success: (data) => {
        ...
        settingsAboutChangelogText.innerHTML = 'Erreur lors du chargement des notes.'
    })
}
...
function populateSettingsUpdateInformation(data){
    if(data != null){
        ...
        if(process.platform === 'darwin'){
            settingsUpdateButtonStatus('Télécharger depuis GitHub<span style="font-size: 10px;color: gray;text-shadow: none !important;">Fermez le launcher et éxécutez le fichier dmg pour mettre à jour.</span>', false, () => {
